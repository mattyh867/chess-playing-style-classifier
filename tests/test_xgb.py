# Usage: python tests/test_xgb.py /path/to/stockfish
#        python tests/test_xgb.py /path/to/stockfish --pgn path/to/game.pgn
#        python tests/test_xgb.py /path/to/stockfish --pgn path/to/game.pgn --color white
...
def main():
    parser = argparse.ArgumentParser(description='Test XGBoost on a single chess game')
    ...
    model = joblib.load(os.path.join(BASE_DIR, 'models/XGB/xgb_model.pkl'))
    scaler = joblib.load(os.path.join(BASE_DIR, 'models/XGB/scaler.pkl'))
    label_encoder = joblib.load(os.path.join(BASE_DIR, 'models/XGB/label_encoder.pkl'))
    feature_cols = joblib.load(os.path.join(BASE_DIR, 'models/XGB/feature_columns.pkl'))
